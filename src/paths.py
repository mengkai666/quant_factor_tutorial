...
CNINFO_ANN_CACHE = os.path.join(DATA_DIR, 'cninfo_announcement_cache.csv')  # 巨潮公告正缓存: code,query_date,ann_date,title,type,severity,url,fetched_at
CNINFO_ANN_NEG_CACHE = os.path.join(DATA_DIR, 'cninfo_announcement_negative_cache.csv')  # 公告负缓存: (code,query_date) 抓失败/空
SECURITY_MASTER_CACHE = os.path.join(DATA_DIR, 'security_master.csv')
